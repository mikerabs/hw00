...
class TestSequenceFunctions(unittest.TestCase):
    ...
    def test_syllables(self):
        ...
        self.assertEqual(self.ld.num_syllables("asdf"), 1)#wrong, returning numSyllables[0] is out of range? so words not part of the cmu dictionary not being handled
